...
(custom-set-variables
 ...
 '(package-selected-packages
   '(elixir-mode dockerfile-mode slime clj-refactor markdown-mode yaml-mode which-key magit tagedit rainbow-delimiters projectile smex ido-completing-read+ cider clojure-mode-extra-font-locking clojure-mode paredit exec-path-from-shell)))
(custom-set-faces
